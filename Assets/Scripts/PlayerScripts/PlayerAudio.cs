...
public class PlayerAudio : MonoBehaviour
{
    ...
    [SerializeField] private float footstepBaseSoundCooldown = 1.5f;
    ...
    public void PlayFootstepSound(float bonusSpeed)
    {
        ...
        {
            float footstepVolume = Mathf.Clamp01(footstepBaseVolume + (bonusSpeed * 0.6f));
            ...
            StartCoroutine(StartFootstepSoundCooldown(footstepBaseSoundCooldown / (bonusSpeed + 1)));
        }
    }
